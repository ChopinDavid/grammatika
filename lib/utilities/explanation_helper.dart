...
class ExplanationHelper {
  ...
  (String?, String?) sentenceExplanation({
    required String bare,
    ...
    switch (correctAnswer.type) {
      ...
      case WordFormType.ruAdjMNom:
        ...
        return (
          'This word is a masculine adjective in the nominative case. This means that it is a word that modifies a masculine noun that is the subject of a verb.${formationExplanation ?? ''}',
      ...
      case WordFormType.ruAdjMGen:
        ...
        return (
          'This word is a masculine adjective in the genitive case. This means that it is a word that modifies a masculine noun that indicates possession, origin, or close association of or to another noun.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjMDat:
        ...
        return (
          'This word is a masculine adjective in the dative case. This means that it is a word that modifies a masculine noun that is the indirect object of a sentence, i.e. the recipient or beneficiary of the main verb.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjMAcc:
        ...
        return (
          'This word is a masculine adjective in the accusative case. This means that it is a word that modifies a masculine noun that is the direct object of a sentence, i.e. the noun which the verb is acting on.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjMInst:
        ...
        return (
          'This word is a masculine adjective in the instrumental case. This means that it is a word that modifies a masculine noun that is the means by or with which the subject accomplishes an action.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      ...
      case WordFormType.ruAdjFNom:
        ...
        return (
          'This word is a feminine adjective in the nominative case. This means that it is a word that modifies a feminine noun that is the subject of a verb.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjFGen:
        ...
        return (
          'This word is a feminine adjective in the genitive case. This means that it is a word that modifies a feminine noun that indicates possession, origin, or close association of or to another noun.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjFDat:
        ...
        return (
          'This word is a feminine adjective in the dative case. This means that it is a word that modifies a feminine noun that is the indirect object of a sentence, i.e. the recipient or beneficiary of the main verb.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjFAcc:
        ...
        return (
          'This word is a feminine adjective in the accusative case. This means that it is a word that modifies a feminine noun that is the direct object of a sentence, i.e. the noun which the verb is acting on.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjFInst:
        ...
        return (
          'This word is a feminine adjective in the instrumental case. This means that it is a word that modifies a feminine noun that is the means by or with which the subject accomplishes an action.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      ...
      case WordFormType.ruAdjNNom:
        ...
        return (
          'This word is a neuter adjective in the nominative case. This means that it is a word that modifies a neuter noun that is the subject of a verb.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjNGen:
        ...
        return (
          'This word is a neuter adjective in the genitive case. This means that it is a word that modifies a neuter noun that indicates possession, origin, or close association of or to another noun.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjNDat:
        ...
        return (
          'This word is a neuter adjective in the dative case. This means that it is a word that modifies a neuter noun that is the indirect object of a sentence, i.e. the recipient or beneficiary of the main verb.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjNAcc:
        String? formationExplanation =
            getAdjNomExplanation(correctAnswer.bare, gender: Gender.n)
                ?.replaceAll('nominative', 'accusative');
        return (
          'This word is a neuter adjective in the accusative case. This means that it is a word that modifies a neuter noun that is the direct object of a sentence, i.e. the noun which the verb is acting on.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjNInst:
        ...
        return (
          'This word is a neuter adjective in the instrumental case. This means that it is a word that modifies a neuter noun that is the means by or with which the subject accomplishes an action.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      ...
      case WordFormType.ruAdjPlNom:
        ...
        return (
          'This word is a plural adjective in the nominative case. This means that it is a word that modifies a plural noun that is the subject of a verb.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjPlGen:
        ...
        return (
          'This word is a plural adjective in the genitive case. This means that it is a word that modifies a plural noun that indicates possession, origin, or close association of or to another noun.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjPlDat:
        ...
        return (
          'This word is a plural adjective in the dative case. This means that it is a word that modifies a plural noun that is the indirect object of a sentence, i.e. the recipient or beneficiary of the main verb.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjPlAcc:
        ...
        return (
          'This word is a plural adjective in the accusative case. This means that it is a word that modifies a plural noun that is the direct object of a sentence, i.e. the noun which the verb is acting on.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruAdjPlInst:
        ...
        return (
          'This word is a plural adjective in the instrumental case. This means that it is a word that modifies a plural noun that is the means by or with which the subject accomplishes an action.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      ...
      case WordFormType.ruVerbImperativeSg:
        ...
        return (
          'This word is an imperative verb. This means it is a verb used to give commands, express requests, or provide advice.${formationExplanation ?? ''}',
          '$bare ➡️ ${wordFormTypesToBareMap[WordFormType.ruVerbPresfutPl3]} ➡️ ${correctAnswer.bare}'
        );
      ...
      case WordFormType.ruVerbPastM:
        ...
        return (
          'This word is a masculine verb in the past tense. This means it describes an action taken by a masculine subject at any point in the past.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruVerbPastF:
        ...
        return (
          'This word is a feminine verb in the past tense. This means it describes an action taken by a feminine subject at any point in the past.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruVerbPastN:
        ...
        return (
          'This word is a neuter verb in the past tense. This means it describes an action taken by a neuter subject at any point in the past.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruVerbPastPl:
        ...
        return (
          'This word is a plural verb in the past tense. This means it describes an action taken by a plural subject at any point in the past.${formationExplanation ?? ''}',
          '${bare.substring(0, bare.length - 2)}- ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruVerbPresfutSg1:
        ...
        return (
          'This word is a 1st-person${isReflexive ? ', reflexive' : ''} verb in the present or future tense. This means it describes an action that has not already been taken by the speaker${isReflexive ? " and whose object is either the same as the subject or doesn't exist" : ''}.${formationExplanation ?? ''}',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruVerbPresfutSg2:
        ...
        return (
          'This word is a 2nd-person${isReflexive ? ', reflexive' : ''} verb in the present or future tense. This means it describes an action that has not already been taken by the person being informally addressed${isReflexive ? " and whose object is either the same as the subject or doesn't exist" : ''}.${formationExplanation ?? ''}',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      ...
      case WordFormType.ruVerbParticiplePassivePast:
        ...
        return (
          'This word is a passive past participle. This means it is a verb form of a completed action that can be used as an adjective to describe the subject of a sentence that experienced said action.$formationExplanation',
      ...
      case WordFormType.ruVerbParticipleActivePresent:
        ...
        return (
          'This word is a${isReflexive ? ' reflexive' : 'n'} active present participle. This means it is a verb form of a uncompleted action that can be used as an adjective to describe the subject of a sentence that is or will be performing said action${isReflexive ? ". This form is also reflexive, meaning the uncompleted verb's object is either the same as the subject or doesn't exist" : ''}.$formationExplanation',
          '$bare ➡️ ${wordFormTypesToBareMap[WordFormType.ruVerbPresfutPl3]} ➡️ ${correctAnswer.bare}'
        );
      ...
      case WordFormType.ruNounSgGen:
        ...
        return (
          'This word is a singular, genitive noun. This means it is a noun that indicates possession, origin, or close association of or to another noun.$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruNounSgDat:
        ...
        return (
          'This word is a singular, dative noun. This means it is a noun describing a single thing that is the indirect object of a sentence, i.e. the recipient or beneficiary of the main verb.$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruNounSgAcc:
        ...
        return (
          'This word is a singular, accusative noun. This means it is a noun describing a single thing that is the direct object of a sentence, i.e. the thing that is acted on by the main verb.$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruNounSgInst:
        ...
        return (
          'This word is a singular, instrumental noun. This means it is a noun describing a single thing that is the means by or with which the subject accomplishes an action.$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruNounSgPrep:
        ...
        return (
          'This word is a singular, prepositional noun. This means it is the object of a preposition, the preposition generally being "в"/"во", "на", "о"/"об", "при", or "по", forming a phrase answering "about who?", "about what?", "in whose presence?", "where?", or "in/on what?".$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruNounPlNom:
        ...
        return (
          'This word is a plural, nominative noun. This means it describes multiple things and is typically the noun that is performing the verb in a sentence, i.e. the sentence\'s subject.$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruNounPlGen:
        ...
        return (
          'This word is a plural, genitive noun. This means it is a noun that describes multiple things and indicates possession, origin, or close association of or to another noun.$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruNounPlDat:
        ...
        return (
          'This word is a plural, dative noun. This means it is a noun describing multiple things that are the indirect object of a sentence, i.e. the recipients or beneficiaries of the main verb.$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruNounPlAcc:
        ...
        return (
          'This word is a plural, accusative noun. This means it is a noun describing multiple things that are the direct object of a sentence, i.e. the things that are acted on by the main verb.$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruNounPlInst:
        ...
        return (
          'This word is a plural, instrumental noun. This means it is a noun describing multiple things that are the means by or with which the subject accomplishes an action.$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
      case WordFormType.ruNounPlPrep:
        ...
        return (
          'This word is a plural, prepositional noun. This means it describes multiple things that are the object of a preposition, the preposition generally being "в"/"во", "на", "о"/"об", "при", or "по", forming a phrase answering "about who?", "about what?", "in whose presence?", "where?", or "in/on what?".$formationExplanation',
          '$bare ➡️ ${correctAnswer.bare}'
        );
